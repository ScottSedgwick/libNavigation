...
testData :: [TestData]
testData =
    [ ("Test Case 1", position 56 20 (-8) 12,   position 52 12 (-57) 10,     1696.5, (Deg 282.5766139), NW, (Deg 241.9789078), SW, W)
    , ("Test Case 2", position (-33) 22 113 8,  position (-10) 51 49 16,     3738.1, (Deg 275.2301109), SW, (Deg 302.1315333), NW, W)
    , ("Test Case 3", position 49 12 (-122) 50, position 13 30 145 15,       4863.4, (Deg 280.3311666), NW, (Deg 000.0), NE, W)    -- Crosses meridian
    , ("Test Case 4", position (-46) 20 169 10, position (-26) 25 (-105) 15, 4099.1, (Deg 106.0742443), SE, (Deg 000.0), NE, E)    -- Crosses meridian
    , ("Test Case 5", position (-17) 0 170 0,   position 22 0 (-110) 0,      5247.2, (Deg  66.0642527), SE, (Deg 070.5113954), NE, E)    -- Crosses meridian and equator
    ]
...
mkInitCourseTest (s, pA, pB, d, ih, iq, fh, fq, idir) = ih ~=? gcInitCourse pA pB
...
mkFinalCourseTest (s, pA, pB, d, ih, iq, fh, fq, idir) = fh ~=? gcFinalCourse pA pB
